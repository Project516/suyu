...
struct Values {
    ...
    SwitchableSetting<bool> use_fast_gpu_time{
        linkage, true, "use_fast_gpu_time", Category::RendererHacks, Specialization::Default,
        true,    true};
...
// Only read/write enable_raw_input on Windows platforms
    ...
    SwitchableSetting<std::string> program_args{
        linkage, std::string(), "program_args", Category::System, Specialization::Default,
    ...
    Setting<bool> optimize_spirv_output{linkage, false, "optimize_spirv_output",
                                        Category::Renderer};
    ...
    Setting<std::string> web_api_url{linkage, "api.ynet-fun.xyz", "web_api_url",
                                     Category::WebService};
    Setting<std::string> suyu_username{linkage, "suyu", "suyu_username", Category::WebService};
    Setting<std::string> suyu_token{linkage, "", "suyu_token", Category::WebService};

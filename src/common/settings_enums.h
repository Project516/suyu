...
EnumMetadata<AudioEngine>::Canonicalizations() {
    return {
        {"auto", AudioEngine::Auto}, {"cubeb", AudioEngine::Cubeb},
        {"sdl3", AudioEngine::Sdl3}, {"null", AudioEngine::Null},
        {"oboe", AudioEngine::Oboe}, {"libretro", AudioEngine::Libretro},
    };
}
...
ENUM(ScalingFilter, NearestNeighbor, Bilinear, Bicubic, Gaussian, Lanczos, ScaleForce, Fsr, Area,
     ZeroTangent, BSpline, Mitchell, Spline1, Mmpx, Sgsr, SgsrEdge);

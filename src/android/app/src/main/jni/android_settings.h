...
struct Values {
    ...
    Settings::Setting<s32> static_theme_color{linkage, 0, "static_theme_color",
                                              Settings::Category::Android};
    ...
    Settings::Setting<u32> input_overlay_auto_hide{linkage,
                                                   ...
                                                   true,
                                                   &enable_input_overlay_auto_hide};
    Settings::Setting<bool> hide_overlay_on_controller_input{linkage,
                                                             true,
    ...
    Settings::Setting<s32> pipeline_worker_count{linkage,
                                                 4,
    ...
    Settings::Setting<bool> show_soc_overlay{linkage,
                                             ...
                                             true,
                                             true};
    Settings::Setting<bool> show_build_id{linkage,
                                          true,
                                          "show_build_id",
                                          Settings::Category::Overlay,
                                          Settings::Specialization::Default,
                                          ...
                                          true,
                                          &show_performance_overlay};
    Settings::Setting<bool> show_driver_version{linkage,
                                                true,
                                                "show_driver_version",
                                                Settings::Category::Overlay,
                                                Settings::Specialization::Default,
    ...
    // MISC
    Settings::Setting<bool> dont_show_driver_shader_warning{linkage,
                                                            false,
                                                            ...
                                                            true,
                                                            true};
    Settings::Setting<bool> enable_quick_settings{linkage,
                                                  true,
